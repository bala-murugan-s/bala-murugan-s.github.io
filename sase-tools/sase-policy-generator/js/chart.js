...
export function drawRulesChart(){
  ...
  const groups=[
    {k:'ziaUrl',label:'ZIA URL'}, {k:'ziaFw',label:'ZIA FW'}, {k:'zpaAccess',label:'ZPA Access'}, {k:'zpaAppseg',label:'ZPA AppSeg'},
    {k:'umbrellaDest',label:'Umb Dest'}, {k:'umbrellaWeb',label:'Umb Web'}, {k:'cfAccess',label:'CF Access'}, {k:'cfGateway',label:'CF Gateway'},
    {k:'prisma',label:'Prisma'}, {k:'netskope',label:'Netskope'}];
